...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // To prevent you from having to define a different index variable for every activity,
        // We are defining this index variable for you here.  Use this as your index variable in all
        // of your loops. But remember to reset it to zero with index = 0
        // (or whichever number you wish to start at), before each of your loop statements!
        int index;
        ...
        // - Fix the loop so that it prints 15 and then stops.
        //
        // Write your code here
